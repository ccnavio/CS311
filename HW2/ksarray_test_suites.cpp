...
// Test program for class template KSArray: test suites
           ...
           "[types]" )
{
    ...
    SECTION( "Move assn returns KSArray by reference" )
    {
        ...
        KSArray<int> & r(mi1 = move(mi_movable1));
    ...
    SECTION( "begin (const) returns ptr-to-item by value" )
    {
        ...
        const KSArray<int>::value_type * && r2(cmi2.begin());
        ...
        const KSArray<double>::value_type * && r4(cmd5.begin());
    ...
    SECTION( "end (const) returns ptr-to-item by value" )
    {
        ...
        const KSArray<int>::value_type * && r2(cmi2.end());
        ...
        const KSArray<double>::value_type * && r4(cmd5.end());
           ...
           "[types]" )
{
    SECTION( "Taking const KSArray arguments" )
    {
        ...
        bool result1 = (cmi1 == cmi2);  // op==(KSArray,KSArray)
        bool result2 = (cmi1 != cmi2);  // op!=(KSArray,KSArray)
        bool result3 = (cmi1 <  cmi2);  // op<(KSArray,KSArray)
        bool result4 = (cmi1 <= cmi2);  // op<=(KSArray,KSArray)
        bool result5 = (cmi1 >  cmi2);  // op>(KSArray,KSArray)
        bool result6 = (cmi1 >= cmi2);  // op>=(KSArray,KSArray)
           ...
           "[types]" )
{
    ...
    {
        KSArray<int> mi_movable;
        REQUIRE( noexcept(KSArray<int>(move(mi_movable))) );
    }
...
TEST_CASE( "Ctor/dctor/assignment count - IMPROVED",
           "[other]" )
{
    const size_t defaultsize = 10;  // Size of default-constructed KSArray
